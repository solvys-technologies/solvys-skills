...
- Start from current repository, runtime, provider, and account truth.
- Name the original problem and outcome-owned solution.
- Run the Stack Interview and Ponytail chain.
