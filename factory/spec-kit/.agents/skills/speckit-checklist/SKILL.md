...
Use this checklist in PL0 to test specification clarity, coverage, edge cases,
Given/When/Then acceptance, and unresolved decisions. It does not replace the
S014 Development Contract or authorize implementation.
