...
Create tracker issues only from an approved, revision-matched Development
Contract. Keep one owner per task, preserve dependencies and proof commands,
and reject duplicate or speculative task sprawl.
