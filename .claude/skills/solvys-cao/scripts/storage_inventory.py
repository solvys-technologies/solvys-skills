...
EXT_RECOVERY = Path("/Volumes/Ext.")
MANAGED_WORKTREE_ROOT = CODEX_HOME / "worktrees" / "managed"
STORAGE_OPS_ROOT = CODEX_HOME / "storage-ops"
FINTHEON_RUNTIME = (
...
def main() -> None:
    payload = {
        ...
        "storageOps": {
            "quarantine": bounded_du(STORAGE_OPS_ROOT / "quarantine"),
            "transcriptArchive": bounded_du(STORAGE_OPS_ROOT / "transcript-archive"),
        },
        "workspaceRoots": {
            "codebases": str(MANAGED_WORKTREE_ROOT),
            ...
            "explicitWorktrees": str(CODEX_HOME / "worktrees"),
        },
    }
