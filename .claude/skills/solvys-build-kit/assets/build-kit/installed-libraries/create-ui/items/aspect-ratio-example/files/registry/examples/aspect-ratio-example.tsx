  ...
  return (
    <Example title="16:9" className="items-center justify-center">
      <AspectRatio ratio={16 / 9} className="bg-weak rounded-lg">
        <Image
          src="https://avatar.vercel.sh/createui1"
          alt="Photo"
          fill
...
function AspectRatio1x1() {
  return (
    <Example title="1:1" className="items-start">
      <AspectRatio ratio={1 / 1} className="bg-weak rounded-lg">
        <Image
          src="https://avatar.vercel.sh/createui1"
          alt="Photo"
          fill
...
function AspectRatio9x16() {
  return (
    <Example title="9:16" className="items-center justify-center">
      <AspectRatio ratio={9 / 16} className="bg-weak rounded-lg">
        <Image
          src="https://avatar.vercel.sh/createui1"
          alt="Photo"
          fill
...
function AspectRatio21x9() {
  return (
    <Example title="21:9" className="items-center justify-center">
      <AspectRatio ratio={21 / 9} className="bg-weak rounded-lg">
        <Image
          src="https://avatar.vercel.sh/createui1"
          alt="Photo"
          fill
