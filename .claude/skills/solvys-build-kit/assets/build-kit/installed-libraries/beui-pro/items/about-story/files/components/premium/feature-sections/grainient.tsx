...
// Keep renderer/program alive across re-renders so the uniform-sync effect can
// update without ever rebuilding the WebGL context.
type GrainientCtx = {
...
export function Grainient({
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      // Removing a canvas does not immediately release its WebGL context.
      // Explicitly release it so route changes and rotating live previews do
      // not evict long-lived canvases such as the landing hero.
